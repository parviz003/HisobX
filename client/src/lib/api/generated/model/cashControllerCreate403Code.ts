...
export type CashControllerCreate403Code = typeof CashControllerCreate403Code[keyof typeof CashControllerCreate403Code];


export const CashControllerCreate403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
