...
export type CashTransactionResponseDtoType = typeof CashTransactionResponseDtoType[keyof typeof CashTransactionResponseDtoType];


export const CashTransactionResponseDtoType = {
  SALE: 'SALE',
