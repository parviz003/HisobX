...
export type UsersControllerGetProfile403Code = typeof UsersControllerGetProfile403Code[keyof typeof UsersControllerGetProfile403Code];


export const UsersControllerGetProfile403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
