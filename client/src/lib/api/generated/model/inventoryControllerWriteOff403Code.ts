...
export type InventoryControllerWriteOff403Code = typeof InventoryControllerWriteOff403Code[keyof typeof InventoryControllerWriteOff403Code];


export const InventoryControllerWriteOff403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
