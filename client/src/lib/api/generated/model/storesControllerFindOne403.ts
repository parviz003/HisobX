...
import type { StoresControllerFindOne403Code } from './storesControllerFindOne403Code';

export type StoresControllerFindOne403 = ErrorResponseDto & {
  statusCode?: number;
  code?: StoresControllerFindOne403Code;
};
