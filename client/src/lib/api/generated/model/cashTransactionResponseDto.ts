 ...
 */
import type { CashSaleDto } from './cashSaleDto';
import type { CashTransactionResponseDtoType } from './cashTransactionResponseDtoType';
import type { CashUserDto } from './cashUserDto';

export interface CashTransactionResponseDto {
  id: number;
  type: CashTransactionResponseDtoType;
  /** Summa (so'mda) */
  amount: number;
  /** Shu harakatdan keyingi balans */
  balance: number;
  /** @nullable */
  note: string | null;
  storeId: number;
