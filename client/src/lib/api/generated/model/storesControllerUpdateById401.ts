...
import type { StoresControllerUpdateById401Code } from './storesControllerUpdateById401Code';

export type StoresControllerUpdateById401 = ErrorResponseDto & {
  statusCode?: number;
  code?: StoresControllerUpdateById401Code;
};
