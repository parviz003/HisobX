...
import type { ReportsControllerGetDaily401Code } from './reportsControllerGetDaily401Code';

export type ReportsControllerGetDaily401 = ErrorResponseDto & {
  statusCode?: number;
  code?: ReportsControllerGetDaily401Code;
};
