...
import type { SalesControllerFindAll401Code } from './salesControllerFindAll401Code';

export type SalesControllerFindAll401 = ErrorResponseDto & {
  statusCode?: number;
  code?: SalesControllerFindAll401Code;
};
