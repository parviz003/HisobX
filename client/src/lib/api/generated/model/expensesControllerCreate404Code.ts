...
export type ExpensesControllerCreate404Code = typeof ExpensesControllerCreate404Code[keyof typeof ExpensesControllerCreate404Code];


export const ExpensesControllerCreate404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
