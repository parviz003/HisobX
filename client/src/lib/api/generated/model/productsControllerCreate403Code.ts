...
export type ProductsControllerCreate403Code = typeof ProductsControllerCreate403Code[keyof typeof ProductsControllerCreate403Code];


export const ProductsControllerCreate403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
