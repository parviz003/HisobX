...
export type InventoryControllerPurchase403Code = typeof InventoryControllerPurchase403Code[keyof typeof InventoryControllerPurchase403Code];


export const InventoryControllerPurchase403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
