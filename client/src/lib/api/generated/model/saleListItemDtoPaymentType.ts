...
export type SaleListItemDtoPaymentType = typeof SaleListItemDtoPaymentType[keyof typeof SaleListItemDtoPaymentType];


export const SaleListItemDtoPaymentType = {
  CASH: 'CASH',
  CREDIT: 'CREDIT',
} as const;
