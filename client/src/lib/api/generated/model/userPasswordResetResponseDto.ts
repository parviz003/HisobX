 ...
 */
import type { UserPasswordResetResponseDtoRole } from './userPasswordResetResponseDtoRole';
import type { UserPasswordResetResponseDtoStatus } from './userPasswordResetResponseDtoStatus';
...
export interface UserPasswordResetResponseDto {
  ...
  /** @nullable */
  name: string | null;
  /** Har doim E.164 formatida */
  phone: string;
  role: UserPasswordResetResponseDtoRole;
  status: UserPasswordResetResponseDtoStatus;
  isActive: boolean;
  /** @nullable */
