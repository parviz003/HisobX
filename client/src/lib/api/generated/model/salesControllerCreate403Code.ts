...
export type SalesControllerCreate403Code = typeof SalesControllerCreate403Code[keyof typeof SalesControllerCreate403Code];


export const SalesControllerCreate403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
