...
export type StoresControllerGetStore404Code = typeof StoresControllerGetStore404Code[keyof typeof StoresControllerGetStore404Code];


export const StoresControllerGetStore404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
