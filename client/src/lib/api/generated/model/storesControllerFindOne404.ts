...
import type { StoresControllerFindOne404Code } from './storesControllerFindOne404Code';

export type StoresControllerFindOne404 = ErrorResponseDto & {
  statusCode?: number;
  code?: StoresControllerFindOne404Code;
};
