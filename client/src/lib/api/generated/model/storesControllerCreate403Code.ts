...
export type StoresControllerCreate403Code = typeof StoresControllerCreate403Code[keyof typeof StoresControllerCreate403Code];


export const StoresControllerCreate403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
