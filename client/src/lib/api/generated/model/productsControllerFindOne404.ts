...
import type { ProductsControllerFindOne404Code } from './productsControllerFindOne404Code';

export type ProductsControllerFindOne404 = ErrorResponseDto & {
  statusCode?: number;
  code?: ProductsControllerFindOne404Code;
};
