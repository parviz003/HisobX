...
export type CustomersControllerFindOne403Code = typeof CustomersControllerFindOne403Code[keyof typeof CustomersControllerFindOne403Code];


export const CustomersControllerFindOne403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
