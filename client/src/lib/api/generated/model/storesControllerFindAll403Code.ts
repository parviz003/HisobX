...
export type StoresControllerFindAll403Code = typeof StoresControllerFindAll403Code[keyof typeof StoresControllerFindAll403Code];


export const StoresControllerFindAll403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
