...
export type UsersControllerResetPassword403Code = typeof UsersControllerResetPassword403Code[keyof typeof UsersControllerResetPassword403Code];


export const UsersControllerResetPassword403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
