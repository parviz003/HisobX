...
export type ReportsControllerGetDaily403Code = typeof ReportsControllerGetDaily403Code[keyof typeof ReportsControllerGetDaily403Code];


export const ReportsControllerGetDaily403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
