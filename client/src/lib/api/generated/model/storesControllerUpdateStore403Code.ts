...
export type StoresControllerUpdateStore403Code = typeof StoresControllerUpdateStore403Code[keyof typeof StoresControllerUpdateStore403Code];


export const StoresControllerUpdateStore403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
