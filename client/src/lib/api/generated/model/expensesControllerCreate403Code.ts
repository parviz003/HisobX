...
export type ExpensesControllerCreate403Code = typeof ExpensesControllerCreate403Code[keyof typeof ExpensesControllerCreate403Code];


export const ExpensesControllerCreate403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
