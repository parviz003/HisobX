...
export type SaleDetailResponseDtoStatus = typeof SaleDetailResponseDtoStatus[keyof typeof SaleDetailResponseDtoStatus];


export const SaleDetailResponseDtoStatus = {
  DRAFT: 'DRAFT',
  CONFIRMED: 'CONFIRMED',
  COMPLETED: 'COMPLETED',
  CANCELLED: 'CANCELLED',
