...
export type CategoriesControllerRemove403Code = typeof CategoriesControllerRemove403Code[keyof typeof CategoriesControllerRemove403Code];


export const CategoriesControllerRemove403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
