...
import type { StoresControllerGetStore401Code } from './storesControllerGetStore401Code';

export type StoresControllerGetStore401 = ErrorResponseDto & {
  statusCode?: number;
  code?: StoresControllerGetStore401Code;
};
