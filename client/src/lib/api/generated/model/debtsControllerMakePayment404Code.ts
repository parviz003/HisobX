...
export type DebtsControllerMakePayment404Code = typeof DebtsControllerMakePayment404Code[keyof typeof DebtsControllerMakePayment404Code];


export const DebtsControllerMakePayment404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
