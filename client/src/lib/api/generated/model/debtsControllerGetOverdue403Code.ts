...
export type DebtsControllerGetOverdue403Code = typeof DebtsControllerGetOverdue403Code[keyof typeof DebtsControllerGetOverdue403Code];


export const DebtsControllerGetOverdue403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
