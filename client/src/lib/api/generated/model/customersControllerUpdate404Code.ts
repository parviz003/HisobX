...
export type CustomersControllerUpdate404Code = typeof CustomersControllerUpdate404Code[keyof typeof CustomersControllerUpdate404Code];


export const CustomersControllerUpdate404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
