...
export type ProductsControllerUpdate404Code = typeof ProductsControllerUpdate404Code[keyof typeof ProductsControllerUpdate404Code];


export const ProductsControllerUpdate404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
