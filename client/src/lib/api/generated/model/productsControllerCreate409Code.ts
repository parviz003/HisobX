...
export type ProductsControllerCreate409Code = typeof ProductsControllerCreate409Code[keyof typeof ProductsControllerCreate409Code];


export const ProductsControllerCreate409Code = {
  CONFLICT: 'CONFLICT',
} as const;
