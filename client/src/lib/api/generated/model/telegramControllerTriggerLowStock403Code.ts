...
export type TelegramControllerTriggerLowStock403Code = typeof TelegramControllerTriggerLowStock403Code[keyof typeof TelegramControllerTriggerLowStock403Code];


export const TelegramControllerTriggerLowStock403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
