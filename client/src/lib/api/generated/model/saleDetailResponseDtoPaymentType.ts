...
export type SaleDetailResponseDtoPaymentType = typeof SaleDetailResponseDtoPaymentType[keyof typeof SaleDetailResponseDtoPaymentType];


export const SaleDetailResponseDtoPaymentType = {
  CASH: 'CASH',
  CREDIT: 'CREDIT',
} as const;
