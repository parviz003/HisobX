...
import type { ExpensesControllerCreate404Code } from './expensesControllerCreate404Code';

export type ExpensesControllerCreate404 = ErrorResponseDto & {
  statusCode?: number;
  code?: ExpensesControllerCreate404Code;
};
