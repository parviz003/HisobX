...
import type { ReportsControllerGetDaily403Code } from './reportsControllerGetDaily403Code';

export type ReportsControllerGetDaily403 = ErrorResponseDto & {
  statusCode?: number;
  code?: ReportsControllerGetDaily403Code;
};
