...
export type CustomersControllerRemove403Code = typeof CustomersControllerRemove403Code[keyof typeof CustomersControllerRemove403Code];


export const CustomersControllerRemove403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
