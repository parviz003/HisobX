...
import type { SalesControllerCreate401Code } from './salesControllerCreate401Code';

export type SalesControllerCreate401 = ErrorResponseDto & {
  statusCode?: number;
  code?: SalesControllerCreate401Code;
};
