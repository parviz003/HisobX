...
export type SalesControllerFindAllStatus = typeof SalesControllerFindAllStatus[keyof typeof SalesControllerFindAllStatus];


export const SalesControllerFindAllStatus = {
  DRAFT: 'DRAFT',
  CONFIRMED: 'CONFIRMED',
  COMPLETED: 'COMPLETED',
  CANCELLED: 'CANCELLED',
