...
import type { UsersControllerUpdate404Code } from './usersControllerUpdate404Code';

export type UsersControllerUpdate404 = ErrorResponseDto & {
  statusCode?: number;
  code?: UsersControllerUpdate404Code;
};
