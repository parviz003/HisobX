...
export type InventoryControllerOpeningStock403Code = typeof InventoryControllerOpeningStock403Code[keyof typeof InventoryControllerOpeningStock403Code];


export const InventoryControllerOpeningStock403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
