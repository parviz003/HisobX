...
export type UsersControllerFindAll403Code = typeof UsersControllerFindAll403Code[keyof typeof UsersControllerFindAll403Code];


export const UsersControllerFindAll403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
