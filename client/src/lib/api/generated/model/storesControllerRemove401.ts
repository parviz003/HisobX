...
import type { StoresControllerRemove401Code } from './storesControllerRemove401Code';

export type StoresControllerRemove401 = ErrorResponseDto & {
  statusCode?: number;
  code?: StoresControllerRemove401Code;
};
