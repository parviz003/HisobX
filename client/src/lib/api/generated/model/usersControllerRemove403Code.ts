...
export type UsersControllerRemove403Code = typeof UsersControllerRemove403Code[keyof typeof UsersControllerRemove403Code];


export const UsersControllerRemove403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
