 ...
 */
import type { SaleCustomerShortDto } from './saleCustomerShortDto';
import type { SaleListItemDtoPaymentType } from './saleListItemDtoPaymentType';
import type { SaleListItemDtoStatus } from './saleListItemDtoStatus';
...
export interface SaleListItemDto {
  ...
  saleNumber: number;
  status: SaleListItemDtoStatus;
  paymentType: SaleListItemDtoPaymentType;
  subtotal: number;
