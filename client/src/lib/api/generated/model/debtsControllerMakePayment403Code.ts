...
export type DebtsControllerMakePayment403Code = typeof DebtsControllerMakePayment403Code[keyof typeof DebtsControllerMakePayment403Code];


export const DebtsControllerMakePayment403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
