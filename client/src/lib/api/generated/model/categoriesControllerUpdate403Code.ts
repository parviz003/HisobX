...
export type CategoriesControllerUpdate403Code = typeof CategoriesControllerUpdate403Code[keyof typeof CategoriesControllerUpdate403Code];


export const CategoriesControllerUpdate403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
