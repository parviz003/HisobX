...
import type { SaleDetailResponseDtoPaymentType } from './saleDetailResponseDtoPaymentType';
import type { SaleDetailResponseDtoStatus } from './saleDetailResponseDtoStatus';
import type { SaleItemResponseDto } from './saleItemResponseDto';
import type { SaleUserDto } from './saleUserDto';

export interface SaleDetailResponseDto {
  id: number;
  /** Do'kon ichidagi tartib raqam */
  saleNumber: number;
  status: SaleDetailResponseDtoStatus;
  paymentType: SaleDetailResponseDtoPaymentType;
  subtotal: number;
