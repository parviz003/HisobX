...
export type DebtsControllerFindOne404Code = typeof DebtsControllerFindOne404Code[keyof typeof DebtsControllerFindOne404Code];


export const DebtsControllerFindOne404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
