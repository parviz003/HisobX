...
export type UserPasswordResetResponseDtoStatus = typeof UserPasswordResetResponseDtoStatus[keyof typeof UserPasswordResetResponseDtoStatus];


export const UserPasswordResetResponseDtoStatus = {
  ACTIVE: 'ACTIVE',
  INACTIVE: 'INACTIVE',
} as const;
