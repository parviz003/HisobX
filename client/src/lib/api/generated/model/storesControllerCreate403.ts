...
import type { StoresControllerCreate403Code } from './storesControllerCreate403Code';

export type StoresControllerCreate403 = ErrorResponseDto & {
  statusCode?: number;
  code?: StoresControllerCreate403Code;
};
