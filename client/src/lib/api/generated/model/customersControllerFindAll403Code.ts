...
export type CustomersControllerFindAll403Code = typeof CustomersControllerFindAll403Code[keyof typeof CustomersControllerFindAll403Code];


export const CustomersControllerFindAll403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
