...
export type UsersControllerUpdateProfile403Code = typeof UsersControllerUpdateProfile403Code[keyof typeof UsersControllerUpdateProfile403Code];


export const UsersControllerUpdateProfile403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
