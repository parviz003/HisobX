...
export type ExpensesControllerRemoveCategory403Code = typeof ExpensesControllerRemoveCategory403Code[keyof typeof ExpensesControllerRemoveCategory403Code];


export const ExpensesControllerRemoveCategory403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
