...
import type { StoresControllerUpdateById404Code } from './storesControllerUpdateById404Code';

export type StoresControllerUpdateById404 = ErrorResponseDto & {
  statusCode?: number;
  code?: StoresControllerUpdateById404Code;
};
