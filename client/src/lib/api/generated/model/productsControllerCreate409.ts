...
import type { ProductsControllerCreate409Code } from './productsControllerCreate409Code';

export type ProductsControllerCreate409 = ErrorResponseDto & {
  statusCode?: number;
  code?: ProductsControllerCreate409Code;
};
