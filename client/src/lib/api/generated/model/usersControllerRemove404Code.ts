...
export type UsersControllerRemove404Code = typeof UsersControllerRemove404Code[keyof typeof UsersControllerRemove404Code];


export const UsersControllerRemove404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
