...
export type StoresControllerOnboard403Code = typeof StoresControllerOnboard403Code[keyof typeof StoresControllerOnboard403Code];


export const StoresControllerOnboard403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
