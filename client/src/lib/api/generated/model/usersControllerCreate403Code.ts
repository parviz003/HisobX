...
export type UsersControllerCreate403Code = typeof UsersControllerCreate403Code[keyof typeof UsersControllerCreate403Code];


export const UsersControllerCreate403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
