...
export type UsersControllerFindOne403Code = typeof UsersControllerFindOne403Code[keyof typeof UsersControllerFindOne403Code];


export const UsersControllerFindOne403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
