...
import type { SalesControllerCreate403Code } from './salesControllerCreate403Code';

export type SalesControllerCreate403 = ErrorResponseDto & {
  statusCode?: number;
  code?: SalesControllerCreate403Code;
};
