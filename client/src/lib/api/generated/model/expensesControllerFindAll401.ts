...
import type { ExpensesControllerFindAll401Code } from './expensesControllerFindAll401Code';

export type ExpensesControllerFindAll401 = ErrorResponseDto & {
  statusCode?: number;
  code?: ExpensesControllerFindAll401Code;
};
