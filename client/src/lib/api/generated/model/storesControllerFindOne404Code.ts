...
export type StoresControllerFindOne404Code = typeof StoresControllerFindOne404Code[keyof typeof StoresControllerFindOne404Code];


export const StoresControllerFindOne404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
