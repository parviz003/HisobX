...
export type ProductsControllerUpdate409Code = typeof ProductsControllerUpdate409Code[keyof typeof ProductsControllerUpdate409Code];


export const ProductsControllerUpdate409Code = {
  CONFLICT: 'CONFLICT',
} as const;
