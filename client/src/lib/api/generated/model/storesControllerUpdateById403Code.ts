...
export type StoresControllerUpdateById403Code = typeof StoresControllerUpdateById403Code[keyof typeof StoresControllerUpdateById403Code];


export const StoresControllerUpdateById403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
