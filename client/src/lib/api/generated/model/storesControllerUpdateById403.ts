...
import type { StoresControllerUpdateById403Code } from './storesControllerUpdateById403Code';

export type StoresControllerUpdateById403 = ErrorResponseDto & {
  statusCode?: number;
  code?: StoresControllerUpdateById403Code;
};
