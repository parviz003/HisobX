...
export type UsersControllerFindOne404Code = typeof UsersControllerFindOne404Code[keyof typeof UsersControllerFindOne404Code];


export const UsersControllerFindOne404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
