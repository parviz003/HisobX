...
import type { SalesControllerFindOne404Code } from './salesControllerFindOne404Code';

export type SalesControllerFindOne404 = ErrorResponseDto & {
  statusCode?: number;
  code?: SalesControllerFindOne404Code;
};
