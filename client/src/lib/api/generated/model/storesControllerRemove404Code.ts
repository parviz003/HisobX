...
export type StoresControllerRemove404Code = typeof StoresControllerRemove404Code[keyof typeof StoresControllerRemove404Code];


export const StoresControllerRemove404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
