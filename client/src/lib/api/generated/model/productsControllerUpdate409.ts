...
import type { ProductsControllerUpdate409Code } from './productsControllerUpdate409Code';

export type ProductsControllerUpdate409 = ErrorResponseDto & {
  statusCode?: number;
  code?: ProductsControllerUpdate409Code;
};
