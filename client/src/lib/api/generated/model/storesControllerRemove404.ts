...
import type { StoresControllerRemove404Code } from './storesControllerRemove404Code';

export type StoresControllerRemove404 = ErrorResponseDto & {
  statusCode?: number;
  code?: StoresControllerRemove404Code;
};
