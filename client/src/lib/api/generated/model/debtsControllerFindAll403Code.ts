...
export type DebtsControllerFindAll403Code = typeof DebtsControllerFindAll403Code[keyof typeof DebtsControllerFindAll403Code];


export const DebtsControllerFindAll403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
