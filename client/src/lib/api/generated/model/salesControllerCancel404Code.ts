...
export type SalesControllerCancel404Code = typeof SalesControllerCancel404Code[keyof typeof SalesControllerCancel404Code];


export const SalesControllerCancel404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
