...
export type DeviceControllerFindAll403Code = typeof DeviceControllerFindAll403Code[keyof typeof DeviceControllerFindAll403Code];


export const DeviceControllerFindAll403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
