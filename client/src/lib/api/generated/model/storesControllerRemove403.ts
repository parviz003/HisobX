...
import type { StoresControllerRemove403Code } from './storesControllerRemove403Code';

export type StoresControllerRemove403 = ErrorResponseDto & {
  statusCode?: number;
  code?: StoresControllerRemove403Code;
};
