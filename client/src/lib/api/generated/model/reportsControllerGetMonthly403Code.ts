...
export type ReportsControllerGetMonthly403Code = typeof ReportsControllerGetMonthly403Code[keyof typeof ReportsControllerGetMonthly403Code];


export const ReportsControllerGetMonthly403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
