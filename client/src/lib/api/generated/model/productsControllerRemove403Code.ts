...
export type ProductsControllerRemove403Code = typeof ProductsControllerRemove403Code[keyof typeof ProductsControllerRemove403Code];


export const ProductsControllerRemove403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
