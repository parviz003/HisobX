...
export type CategoriesControllerRemove404Code = typeof CategoriesControllerRemove404Code[keyof typeof CategoriesControllerRemove404Code];


export const CategoriesControllerRemove404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
