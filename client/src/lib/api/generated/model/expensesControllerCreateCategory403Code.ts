...
export type ExpensesControllerCreateCategory403Code = typeof ExpensesControllerCreateCategory403Code[keyof typeof ExpensesControllerCreateCategory403Code];


export const ExpensesControllerCreateCategory403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
