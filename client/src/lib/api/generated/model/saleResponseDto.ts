 ...
 */
import type { SaleResponseDtoPaymentType } from './saleResponseDtoPaymentType';
import type { SaleResponseDtoStatus } from './saleResponseDtoStatus';

export interface SaleResponseDto {
  id: number;
  /** Do'kon ichidagi tartib raqam */
  saleNumber: number;
  status: SaleResponseDtoStatus;
  paymentType: SaleResponseDtoPaymentType;
  subtotal: number;
