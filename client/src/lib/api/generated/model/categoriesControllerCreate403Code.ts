...
export type CategoriesControllerCreate403Code = typeof CategoriesControllerCreate403Code[keyof typeof CategoriesControllerCreate403Code];


export const CategoriesControllerCreate403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
