...
export type ProductsControllerFindAll403Code = typeof ProductsControllerFindAll403Code[keyof typeof ProductsControllerFindAll403Code];


export const ProductsControllerFindAll403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
