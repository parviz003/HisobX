...
export type CashControllerGetBalance403Code = typeof CashControllerGetBalance403Code[keyof typeof CashControllerGetBalance403Code];


export const CashControllerGetBalance403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
