...
import type { SalesControllerFindAll403Code } from './salesControllerFindAll403Code';

export type SalesControllerFindAll403 = ErrorResponseDto & {
  statusCode?: number;
  code?: SalesControllerFindAll403Code;
};
