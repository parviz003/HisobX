...
export type CustomersControllerFindOne404Code = typeof CustomersControllerFindOne404Code[keyof typeof CustomersControllerFindOne404Code];


export const CustomersControllerFindOne404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
