...
export type TelegramControllerSendTest403Code = typeof TelegramControllerSendTest403Code[keyof typeof TelegramControllerSendTest403Code];


export const TelegramControllerSendTest403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
