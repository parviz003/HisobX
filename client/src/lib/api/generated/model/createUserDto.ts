...
export interface CreateUserDto {
  ...
  /** SUPERADMIN uchun majburiy — xodim qo'shiladigan mavjud do'kon ID'si. ADMIN uchun e'tiborsiz qoldiriladi (o'z do'koni ishlatiladi). Yangi do'kon + ADMIN yaratish uchun POST /stores/onboard ishlatiladi. */
  storeId?: number;
}
