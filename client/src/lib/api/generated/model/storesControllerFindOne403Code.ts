...
export type StoresControllerFindOne403Code = typeof StoresControllerFindOne403Code[keyof typeof StoresControllerFindOne403Code];


export const StoresControllerFindOne403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
