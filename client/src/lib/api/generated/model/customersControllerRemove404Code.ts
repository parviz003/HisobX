...
export type CustomersControllerRemove404Code = typeof CustomersControllerRemove404Code[keyof typeof CustomersControllerRemove404Code];


export const CustomersControllerRemove404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
