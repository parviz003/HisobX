...
export type UsersControllerResetPassword404Code = typeof UsersControllerResetPassword404Code[keyof typeof UsersControllerResetPassword404Code];


export const UsersControllerResetPassword404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
