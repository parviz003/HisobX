...
export type CustomersControllerUpdate403Code = typeof CustomersControllerUpdate403Code[keyof typeof CustomersControllerUpdate403Code];


export const CustomersControllerUpdate403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
