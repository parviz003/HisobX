...
export type SalesControllerCancel403Code = typeof SalesControllerCancel403Code[keyof typeof SalesControllerCancel403Code];


export const SalesControllerCancel403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
