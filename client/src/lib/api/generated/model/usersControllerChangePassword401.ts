...
import type { UsersControllerChangePassword401Code } from './usersControllerChangePassword401Code';

export type UsersControllerChangePassword401 = ErrorResponseDto & {
  statusCode?: number;
  code?: UsersControllerChangePassword401Code;
};
