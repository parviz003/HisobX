...
export type ProductsControllerRemove404Code = typeof ProductsControllerRemove404Code[keyof typeof ProductsControllerRemove404Code];


export const ProductsControllerRemove404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
