...
import type { ProductsControllerCreate403Code } from './productsControllerCreate403Code';

export type ProductsControllerCreate403 = ErrorResponseDto & {
  statusCode?: number;
  code?: ProductsControllerCreate403Code;
};
