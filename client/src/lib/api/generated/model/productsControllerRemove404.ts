...
import type { ProductsControllerRemove404Code } from './productsControllerRemove404Code';

export type ProductsControllerRemove404 = ErrorResponseDto & {
  statusCode?: number;
  code?: ProductsControllerRemove404Code;
};
