...
export type CategoriesControllerFindAll403Code = typeof CategoriesControllerFindAll403Code[keyof typeof CategoriesControllerFindAll403Code];


export const CategoriesControllerFindAll403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
