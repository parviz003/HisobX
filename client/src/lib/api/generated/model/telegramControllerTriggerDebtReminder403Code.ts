...
export type TelegramControllerTriggerDebtReminder403Code = typeof TelegramControllerTriggerDebtReminder403Code[keyof typeof TelegramControllerTriggerDebtReminder403Code];


export const TelegramControllerTriggerDebtReminder403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
