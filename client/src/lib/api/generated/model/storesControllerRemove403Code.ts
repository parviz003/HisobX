...
export type StoresControllerRemove403Code = typeof StoresControllerRemove403Code[keyof typeof StoresControllerRemove403Code];


export const StoresControllerRemove403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
