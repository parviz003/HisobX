...
export type ProductsControllerFindOne404Code = typeof ProductsControllerFindOne404Code[keyof typeof ProductsControllerFindOne404Code];


export const ProductsControllerFindOne404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
