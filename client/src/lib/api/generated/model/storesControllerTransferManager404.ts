...
import type { StoresControllerTransferManager404Code } from './storesControllerTransferManager404Code';

export type StoresControllerTransferManager404 = ErrorResponseDto & {
  statusCode?: number;
  code?: StoresControllerTransferManager404Code;
};
