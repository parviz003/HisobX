...
export type InventoryControllerPurchase404Code = typeof InventoryControllerPurchase404Code[keyof typeof InventoryControllerPurchase404Code];


export const InventoryControllerPurchase404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
