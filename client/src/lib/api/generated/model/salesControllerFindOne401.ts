...
import type { SalesControllerFindOne401Code } from './salesControllerFindOne401Code';

export type SalesControllerFindOne401 = ErrorResponseDto & {
  statusCode?: number;
  code?: SalesControllerFindOne401Code;
};
