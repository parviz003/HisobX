...
export type CategoriesControllerCreate409Code = typeof CategoriesControllerCreate409Code[keyof typeof CategoriesControllerCreate409Code];


export const CategoriesControllerCreate409Code = {
  CONFLICT: 'CONFLICT',
} as const;
