...
import type { ProductsControllerUpdate404Code } from './productsControllerUpdate404Code';

export type ProductsControllerUpdate404 = ErrorResponseDto & {
  statusCode?: number;
  code?: ProductsControllerUpdate404Code;
};
