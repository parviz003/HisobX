...
export type SalesControllerFindAllPaymentType = typeof SalesControllerFindAllPaymentType[keyof typeof SalesControllerFindAllPaymentType];


export const SalesControllerFindAllPaymentType = {
  CASH: 'CASH',
  CREDIT: 'CREDIT',
} as const;
