...
import type { SalesControllerFindOne403Code } from './salesControllerFindOne403Code';

export type SalesControllerFindOne403 = ErrorResponseDto & {
  statusCode?: number;
  code?: SalesControllerFindOne403Code;
};
