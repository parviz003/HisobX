...
export type StoresControllerUpdateStore404Code = typeof StoresControllerUpdateStore404Code[keyof typeof StoresControllerUpdateStore404Code];


export const StoresControllerUpdateStore404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
