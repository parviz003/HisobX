...
export type CustomersControllerCreate403Code = typeof CustomersControllerCreate403Code[keyof typeof CustomersControllerCreate403Code];


export const CustomersControllerCreate403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
