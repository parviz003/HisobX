...
export type DebtsControllerFindOne403Code = typeof DebtsControllerFindOne403Code[keyof typeof DebtsControllerFindOne403Code];


export const DebtsControllerFindOne403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
