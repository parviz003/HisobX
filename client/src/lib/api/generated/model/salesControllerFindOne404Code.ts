...
export type SalesControllerFindOne404Code = typeof SalesControllerFindOne404Code[keyof typeof SalesControllerFindOne404Code];


export const SalesControllerFindOne404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
