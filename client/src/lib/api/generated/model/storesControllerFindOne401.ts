...
import type { StoresControllerFindOne401Code } from './storesControllerFindOne401Code';

export type StoresControllerFindOne401 = ErrorResponseDto & {
  statusCode?: number;
  code?: StoresControllerFindOne401Code;
};
