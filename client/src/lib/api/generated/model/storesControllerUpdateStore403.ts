...
import type { StoresControllerUpdateStore403Code } from './storesControllerUpdateStore403Code';

export type StoresControllerUpdateStore403 = ErrorResponseDto & {
  statusCode?: number;
  code?: StoresControllerUpdateStore403Code;
};
