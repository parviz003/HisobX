...
export type StoresControllerUpdateById404Code = typeof StoresControllerUpdateById404Code[keyof typeof StoresControllerUpdateById404Code];


export const StoresControllerUpdateById404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
