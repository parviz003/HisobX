...
import type { StoresControllerUpdateStore404Code } from './storesControllerUpdateStore404Code';

export type StoresControllerUpdateStore404 = ErrorResponseDto & {
  statusCode?: number;
  code?: StoresControllerUpdateStore404Code;
};
