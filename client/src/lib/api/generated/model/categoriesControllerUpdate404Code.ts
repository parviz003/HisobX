...
export type CategoriesControllerUpdate404Code = typeof CategoriesControllerUpdate404Code[keyof typeof CategoriesControllerUpdate404Code];


export const CategoriesControllerUpdate404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
