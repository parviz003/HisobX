...
import type { StoresControllerUpdateStore401Code } from './storesControllerUpdateStore401Code';

export type StoresControllerUpdateStore401 = ErrorResponseDto & {
  statusCode?: number;
  code?: StoresControllerUpdateStore401Code;
};
