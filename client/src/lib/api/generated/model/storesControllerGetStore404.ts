...
import type { StoresControllerGetStore404Code } from './storesControllerGetStore404Code';

export type StoresControllerGetStore404 = ErrorResponseDto & {
  statusCode?: number;
  code?: StoresControllerGetStore404Code;
};
