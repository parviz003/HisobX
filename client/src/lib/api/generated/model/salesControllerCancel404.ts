...
import type { SalesControllerCancel404Code } from './salesControllerCancel404Code';

export type SalesControllerCancel404 = ErrorResponseDto & {
  statusCode?: number;
  code?: SalesControllerCancel404Code;
};
