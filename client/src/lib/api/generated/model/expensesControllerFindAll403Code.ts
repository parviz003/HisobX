...
export type ExpensesControllerFindAll403Code = typeof ExpensesControllerFindAll403Code[keyof typeof ExpensesControllerFindAll403Code];


export const ExpensesControllerFindAll403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
