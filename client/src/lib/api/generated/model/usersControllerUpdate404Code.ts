...
export type UsersControllerUpdate404Code = typeof UsersControllerUpdate404Code[keyof typeof UsersControllerUpdate404Code];


export const UsersControllerUpdate404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
