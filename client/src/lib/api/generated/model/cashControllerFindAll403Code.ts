...
export type CashControllerFindAll403Code = typeof CashControllerFindAll403Code[keyof typeof CashControllerFindAll403Code];


export const CashControllerFindAll403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
