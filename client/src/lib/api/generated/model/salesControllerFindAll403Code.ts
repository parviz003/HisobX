...
export type SalesControllerFindAll403Code = typeof SalesControllerFindAll403Code[keyof typeof SalesControllerFindAll403Code];


export const SalesControllerFindAll403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
