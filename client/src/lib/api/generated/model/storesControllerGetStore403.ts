...
import type { StoresControllerGetStore403Code } from './storesControllerGetStore403Code';

export type StoresControllerGetStore403 = ErrorResponseDto & {
  statusCode?: number;
  code?: StoresControllerGetStore403Code;
};
