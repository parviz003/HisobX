...
export type UsersControllerUpdate403Code = typeof UsersControllerUpdate403Code[keyof typeof UsersControllerUpdate403Code];


export const UsersControllerUpdate403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
