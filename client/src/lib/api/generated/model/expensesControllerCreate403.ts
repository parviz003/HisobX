...
import type { ExpensesControllerCreate403Code } from './expensesControllerCreate403Code';

export type ExpensesControllerCreate403 = ErrorResponseDto & {
  statusCode?: number;
  code?: ExpensesControllerCreate403Code;
};
