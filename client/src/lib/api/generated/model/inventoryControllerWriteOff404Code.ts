...
export type InventoryControllerWriteOff404Code = typeof InventoryControllerWriteOff404Code[keyof typeof InventoryControllerWriteOff404Code];


export const InventoryControllerWriteOff404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
