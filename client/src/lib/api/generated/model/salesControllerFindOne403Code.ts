...
export type SalesControllerFindOne403Code = typeof SalesControllerFindOne403Code[keyof typeof SalesControllerFindOne403Code];


export const SalesControllerFindOne403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
