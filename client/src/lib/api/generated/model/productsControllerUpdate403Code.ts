...
export type ProductsControllerUpdate403Code = typeof ProductsControllerUpdate403Code[keyof typeof ProductsControllerUpdate403Code];


export const ProductsControllerUpdate403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
