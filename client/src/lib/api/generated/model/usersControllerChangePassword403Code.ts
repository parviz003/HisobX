...
export type UsersControllerChangePassword403Code = typeof UsersControllerChangePassword403Code[keyof typeof UsersControllerChangePassword403Code];


export const UsersControllerChangePassword403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
