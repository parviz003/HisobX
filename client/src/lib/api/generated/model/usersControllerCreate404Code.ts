...
export type UsersControllerCreate404Code = typeof UsersControllerCreate404Code[keyof typeof UsersControllerCreate404Code];


export const UsersControllerCreate404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
