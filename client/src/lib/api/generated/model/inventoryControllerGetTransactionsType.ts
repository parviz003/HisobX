...
export type InventoryControllerGetTransactionsType = typeof InventoryControllerGetTransactionsType[keyof typeof InventoryControllerGetTransactionsType];


export const InventoryControllerGetTransactionsType = {
  PURCHASE: 'PURCHASE',
  SALE: 'SALE',
  WRITE_OFF: 'WRITE_OFF',
  OPENING: 'OPENING',
