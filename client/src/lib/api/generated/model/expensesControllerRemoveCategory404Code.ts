...
export type ExpensesControllerRemoveCategory404Code = typeof ExpensesControllerRemoveCategory404Code[keyof typeof ExpensesControllerRemoveCategory404Code];


export const ExpensesControllerRemoveCategory404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
