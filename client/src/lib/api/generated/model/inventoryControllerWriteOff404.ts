...
import type { InventoryControllerWriteOff404Code } from './inventoryControllerWriteOff404Code';

export type InventoryControllerWriteOff404 = ErrorResponseDto & {
  statusCode?: number;
  code?: InventoryControllerWriteOff404Code;
};
