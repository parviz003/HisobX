...
export type ProductsControllerFindOne403Code = typeof ProductsControllerFindOne403Code[keyof typeof ProductsControllerFindOne403Code];


export const ProductsControllerFindOne403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
