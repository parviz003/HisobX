 ...
 */
import type { InventoryOperationResponseDto } from './inventoryOperationResponseDto';

export type InventoryControllerOpeningStock201 = {
  statusCode: number;
  data: InventoryOperationResponseDto;
};
