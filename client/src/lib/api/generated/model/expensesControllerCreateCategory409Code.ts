...
export type ExpensesControllerCreateCategory409Code = typeof ExpensesControllerCreateCategory409Code[keyof typeof ExpensesControllerCreateCategory409Code];


export const ExpensesControllerCreateCategory409Code = {
  CONFLICT: 'CONFLICT',
} as const;
