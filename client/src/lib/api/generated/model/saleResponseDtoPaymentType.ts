...
export type SaleResponseDtoPaymentType = typeof SaleResponseDtoPaymentType[keyof typeof SaleResponseDtoPaymentType];


export const SaleResponseDtoPaymentType = {
  CASH: 'CASH',
  CREDIT: 'CREDIT',
} as const;
