 ...
 * Kassa harakati turi
 */
export type CreateCashTransactionDtoType = typeof CreateCashTransactionDtoType[keyof typeof CreateCashTransactionDtoType];


export const CreateCashTransactionDtoType = {
  SALE: 'SALE',
