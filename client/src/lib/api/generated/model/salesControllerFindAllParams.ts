 ...
 */
import type { SalesControllerFindAllPaymentType } from './salesControllerFindAllPaymentType';
import type { SalesControllerFindAllStatus } from './salesControllerFindAllStatus';

export type SalesControllerFindAllParams = {
/**
 * @minimum 1
 */
page?: number;
/**
 * Bir sahifadagi yozuvlar soni (ko'pi bilan 100)
 * @minimum 1
 * @maximum 100
 */
limit?: number;
status?: SalesControllerFindAllStatus;
paymentType?: SalesControllerFindAllPaymentType;
customerId?: number;
startDate?: string;
endDate?: string;
};
