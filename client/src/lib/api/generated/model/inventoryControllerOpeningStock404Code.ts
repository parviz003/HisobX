...
export type InventoryControllerOpeningStock404Code = typeof InventoryControllerOpeningStock404Code[keyof typeof InventoryControllerOpeningStock404Code];


export const InventoryControllerOpeningStock404Code = {
  NOT_FOUND: 'NOT_FOUND',
} as const;
