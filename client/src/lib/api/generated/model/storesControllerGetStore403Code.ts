...
export type StoresControllerGetStore403Code = typeof StoresControllerGetStore403Code[keyof typeof StoresControllerGetStore403Code];


export const StoresControllerGetStore403Code = {
  FORBIDDEN: 'FORBIDDEN',
} as const;
