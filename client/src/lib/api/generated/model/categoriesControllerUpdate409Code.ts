...
export type CategoriesControllerUpdate409Code = typeof CategoriesControllerUpdate409Code[keyof typeof CategoriesControllerUpdate409Code];


export const CategoriesControllerUpdate409Code = {
  CONFLICT: 'CONFLICT',
} as const;
